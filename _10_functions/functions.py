...
# Функция заглушка, которая ничего не возвращает:
def nothing():
    print("This function does nothing.")


# Функция заглушка, которая ничего не возвращает и ничего не делает, то
# используется слово pass:
def nothing():
    pass
...
# символ * - обязывает программиста писать название аргумента со значением!!!
# Дзэн оф Пайтон.
# Тип возвращаемого функцией значения пишется через: -> Type
...
# Соблюдай правила типов!!! Правильно пиши функции:
numbers_123 = ['1', '2', '3', '4', '5']
print(find_average(numbers_123))  # TypeError: unsupported operand type(s) for +: 'int' and 'str'
