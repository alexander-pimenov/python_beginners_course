# Слайсы нужны для выбора диапазона значений
...
# Если нужен весь список, то можно не указывать индексы:
...
# Выбрать слайс с шагом =2:
print(numbers[0:10:2])  # Outputs: [0, 2, 4, 6, 8]
print(numbers[::2])  # Outputs: [0, 2, 4, 6, 8]

# Знак "-" разворачивает список:
# шаг 2:
print(numbers[::-2])  # Outputs: [9, 7, 5, 3, 1]
# шаг 3:
print(numbers[::-3])  # Outputs:[9, 6, 3, 0]
