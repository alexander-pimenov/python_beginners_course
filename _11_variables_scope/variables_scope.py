# Совет: вне скоупа функции нужно использовать константы.
...
# Это абсолютное зло с использованием спец слова global, приведенное для примера:
global_var = "I'm a global variable"
...
# Тут приведен хороший пример использования констант в коде:
